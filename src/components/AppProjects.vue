  ...
  <section class="projects" ref="projects">
      ...
      <div class="projects-box">
        <div class="projects-grid-box">
          <div
            ...
            :key="project.id"
            :style="{ 'background-image': 'url(' + project.imgSrc + ')' }"
          >
            <div class="after-card">
              ...
              >
                More Details
                <img
                  src="@/assets/font-icon/eye-solid.svg"
                  width="20"
                  height="15"
                  alt=""
                />
        ...
        <div style="text-align:center;">
          <router-link to="projects"
            ><button class="btn-primary btn-view-all">
    ...
    <transition name="fade">
      <AppSidebar
        ...
        @close="closeModal"
        :sidebarTitle="itemTitle"
        :sidebarDesc="itemDesc"
        :sidebarTools="itemTools"
        :sidebarLink="itemLink"
        :sidebarImages="itemsImgs"
      />
    </transition>
  </section>
</template>
      ...
      projects: [
        {
          ...
          title: "Food Buddy",
          desc:
            "We're only 2 programmer created this app, made with WordPress. We configured woocommerce, added google map API and payment portal, etc. Food Buddy services is an online based food delivery platform that can easily provide you the experience of eating what you want wherever you are. It primarily operates in Luzon cities and provinces.",
        ...
        },
        {
          ...
          desc:
            "Advantage Lifts is your online home for the most reliable, high-quality residential and commercial 2-Post and 4-Post auto lifts for sale.",
        ...
        },
        {
          ...
          desc:
            "Automotive Lift Service is the leading automotive equipment company in the Mid-Atlantic region. Started in 1978, it's perfectly located in south-central Pennsylvania to service urgent needs of our customers located in Pennsylvania, Maryland, Delaware, Virginia, and West Virginia.",
        ...
        },
        {
          ...
          desc:
            "I made it with WordPress, it's hosted on GoDaddy. Also I design the whole website in Photshop then converted it to website. KC Pool Services is an Independent, family owned and operated pool and spa service, have almost 35 years of experience in the construction and service industries and know what it takes to provide quality service to our customers.",
        ...
        },
        {
          ...
          desc:
            "I made it with WordPress in 2020 when I was starting my web dev career. Not active, I created this site in 2020 and this is one of my favorite design.",
