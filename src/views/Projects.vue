    ...
    return {
      ...
      projects: [
        ...
        },
        {
          ...
          tools: ["WordPress", "Google Map API"],
        ...
        },
        {
          ...
          tools: ["WordPress", "WooCommerce", "Google Map API"],
          imgSrc: require("@/assets/projects/food-buddy-ss.jpg"),
          imagesSrc: ["food-buddy-sb-1", "food-buddy-sb-2", "food-buddy-sb-3"],
        },
        {
          id: 9,
          title: "Lido Cocina Tsina",
          // desc: "I maintain all the tools of the website.",
          link: "https://www.lidodelivery.com/",
          tools: ["WordPress", "WooCommerce", "OFS API"],
          imgSrc: require("@/assets/projects/lido-delivery-website.jpg"),
          imagesSrc: ["lido-website"],
        },
      ],
    };
  },
