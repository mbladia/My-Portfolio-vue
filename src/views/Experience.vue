    ...
    <div class="intro-row" ref="introRow">
      <div class="container">
        <div class="introduction-box">
          <p>
            Hello! I'm <b>Mark Bryan</b> and I enjoy creating interactive
            websites. I graduated with bachelor's degree in Infomation
            Technology major in Web Tech at University of the Cordilleras.
          </p>
          <p>
            I've experience in web hosting, e-commerce, API, SEO, debugging and
            responsive web design, my other skills are graphics design and video
            editing.
          </p>
          <p>
            My main focus these days is building accessible, fast and secured
            web app.
          </p>
        </div>
        ...
        <div class="work-box">
          <div class="company-tab">
            <tabs ref="tabs" v-model="active">
              <tab v-for="company in companies" :key="company.name">{{
                company.name
              }}</tab>
              <!-- <tab>Food Buddy</tab> -->
            </tabs>
          ...
          <div class="work-details">
            <tab-panels v-model="active">
              <tab-panel v-for="company in companies" :key="company.name">
                <h1>
                  {{ company.job }}
                  <a @click="externalLink(company.link)"
                    >@{{ company.where }}</a
                  >
                </h1>
                ...
                <ul>
                  <li
                    v-for="responsibility in company.responsibilities"
                    :key="responsibility"
                  >
                    {{ responsibility }}
                  </li>
